...
class EditTerminalForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
    "terminalinformation":{
          ...
          "opendraweronpay":true,
          "printcashreceiptonpay":true,
          "printcreditreceiptonpay":true,
          "printgiftreceiptonpay":true,
          "printitemizedreceiptonpay":true,
          "profitcenterid":"",
          "profitcentername":"",
          "rebootonhouseclose":true,
          "scalecomport":"",
          "screensavertimeoutseconds":"0",
          "showmousecursor":true,
          "showterminallockedoncfd":true,
          "store_id":"1627aea5-8e0a-4371-9022-9b504344e724",
          "systemcomflags":0,
          "timestamp":"",
          "useorderlabel":true,
          "useproductgroupprintermapping":true,
          "printerexclusions":[],
          },
...
convertDataURIToBinary(dataURI) {
  ...
  getPreview2(file){
      ...
      console.log(terminalinformation['customlogoimagepath']);
      this.setState({
        terminalinformation: terminalinformation
    })
  }
...
getSingleTerminal() {
    ...
    terminalid = this.props.location.split('/')[2];
    //console.log(terminalid)

    reqQuery['userdetails'] = getUserDetails();
    reqQuery['terminalid'] = terminalid;
    ...
    axios.post(`${process.env.API_HOST}/ManageTerminals.svc/GetSingleTerminal/json`,reqQuery)
     .then(function (response) {
      ...
      var response,
       ...
       localprinterid,
       menugroupid,
       ProcessorConfigurations_id,
       customlogoimagepath,
       customprintimagepath,
       customscreenimagepath,
       base641,
       base642,
       base643;
        ...
        for(var j=0; j< response.data.singleterminal.printerexclusions.length;j++)
        {
          selectedproductgroups.push(response.data.singleterminal.printerexclusions[j].id);
          //console.log(response.data.singleterminal.printerexclusions[j].id);
        }
         console.log(selectedproductgroups)

      response = response.data.singleterminal;
      customlogoimagepath = response.customlogoimagepath,
      customprintimagepath = response.customprintimagepath,
      customscreenimagepath = response.customscreenimagepath



      //base64 image convert
      base641 = customlogoimagepath != null ? "data:image/jpg;base64,"+ arrayBufferToBase64(customlogoimagepath):"";
      base642 = customprintimagepath != null ? "data:image/jpg;base64,"+ arrayBufferToBase64(customprintimagepath):"";
      base643 = customscreenimagepath != null ? "data:image/jpg;base64,"+ arrayBufferToBase64(customscreenimagepath):"";



      var terminalinformation = response;
      terminalinformation['customlogoimagepath'] = base641;
      terminalinformation['customprintimagepath'] = base642;
      terminalinformation['customscreenimagepath'] = base643;
      ...
      that.setState({
        ...
        scaleport_value: {
          label: response.scalecomport,
          value: response.scalecomport
        },
       displayport_value: {
          label: response.customerdisplaycomport,
          value: response.customerdisplaycomport
        }
      })
     })
    ...
    let getTerminalState = this.state.terminalinformation;
      ...
      getTerminalState['customerdisplaycomport'] = this.state.displayport_value.value;
       ...
       var terminalinformation = this.state.terminalinformation;
        ...
        terminalinformation.printerexclusions = prodtgroups;

        reqQuery['terminalinformation'] = getTerminalState;

      console.log(JSON.stringify(reqQuery))
      //return false;
    axios.post(`${process.env.API_HOST}/ManageTerminals.svc/UpdateTerminal/json`, reqQuery)
     .then(function (response) {
     // console.log(response)
    ...
    return(
      <form>
          ...
          <div className="widget widget-small">
              ...
              label="Terminal Name"
              required="*"
              value={terminalinformation.name}
              placeholder=""
          ...
          <div className="row">
              <div className="col-sm-6">
                 <div className={classnames('form-group', { error: !!this.state.errors.selectProfitCenterList})}>
                    ...
                    <Select
                        name="profitcenters"
                        value={this.state.selectProfitCenterList}
              ...
              <div className="col-sm-6">
                  <div className={classnames('form-group', { error: !!this.state.errors.selectmenusList})}>
                      ...
                      <Select
                          name="menugroups"
                          value={this.state.selectmenusList}
                          options={MenuGroups}
          ...
          <div className="row">
              <div className="col-sm-6">
                  <div className="form-group">
                      ...
                      <Select
                          ...
                          value={this.state.selectprocessorconfigrationlist}
              ...
              <div className="col-sm-6">
                  <div className="form-group">
                      ...
                      <Select
                          name="localprinters"
                          value={this.state.selectLocalPrinterList}
                  ...
                  <div className="col-sm-6">
                      <div className="form-group">
                          <TextInput
                              ...
                              value={terminalinformation.numbercashreceipts}
                              placeholder=" "
                              className="form-control"
                              onChange={this.onChange}
                              />
                  ...
                  <div className="col-sm-6">
                      <div className="form-group">
                          <TextInput
                              ...
                              value={terminalinformation.numbercreditreceipts}
                              placeholder=" "
                              className="form-control"
                              onChange={this.onChange}
                              />
                  ...
                  <div className="col-sm-4">
                      <div className="form-group">
                          <TextInput
                              ...
                              label="Screen Timeout(Recommended 1000)"
                              value={terminalinformation.screensavertimeoutseconds}
                              placeholder=" "
                              className="form-control"
                              onChange={this.onChange}
                              />
                  ...
                  <div className="col-sm-4">
                      <div className="form-group">
                          <TextInput
                              ...
                              label="# Cash Drawers"
                              value={terminalinformation.numberofcashdrawers}
                              placeholder=" "
                              className="form-control"
                              onChange={this.onChange}
                              />
                  ...
                  <div className="col-sm-4">
                      <div className="form-group">
                          <TextInput
                              ...
                              value={terminalinformation.firstcashdrawernumber}
                              placeholder=" "
                              className="form-control"
                              onChange={this.onChange}
                              />
                  ...
                  <div className="form-group">
                     ...
                     <div className="">
                        <div className="switch-button switch-button-info">
                           ...
                           checked={terminalinformation.printcashreceiptonpay}
                  ...
                  <div className="form-group">
                     ...
                     <div className="">
                        <div className="switch-button switch-button-info">
                           <input type="checkbox"
                           onChange={this.handlechange}
                           checked={terminalinformation.printcreditreceiptonpay}
                    ...
                    <div className="form-group">
                     ...
                     <div className="">
                        <div className="switch-button switch-button-info">
                           ...
                           disabled
                           onChange={this.handlechange}
                           checked={terminalinformation.printitemizedreceiptonpay}
                    ...
                    <div className="form-group">
                     ...
                     <div className="">
                        <div className="switch-button switch-button-info">
                           <input type="checkbox"
                           onChange={this.handlechange}
                           checked={terminalinformation.opendraweronpay}
                    ...
                    <div className="form-group">
                     ...
                     <div className="">
                        <div className="switch-button switch-button-info">
                           <input type="checkbox"
                           onChange={this.handlechange}
                           checked={terminalinformation.createautoseats}
                    ...
                    <div className="form-group">
                     ...
                     <div className="">
                        <div className="switch-button switch-button-info">
                           <input type="checkbox"
                           onChange={this.handlechange}
                           checked={terminalinformation.enablecustomerdisplay}
                    ...
                    <div className="form-group">
                     ...
                     <div className="">
                        <div className="switch-button switch-button-info">
                           <input type="checkbox"
                           onChange={this.handlechange}
                           checked={terminalinformation.showmousecursor}
                    ...
                    <div className="form-group">
                     ...
                     <div className="">
                        <div className="switch-button switch-button-info">
                           <input type="checkbox"
                           onChange={this.handlechange}
                           checked={terminalinformation.enablecardlogin}
                    ...
                    <div className="form-group">
                     ...
                     <div className="">
                        <div className="switch-button switch-button-info">
                           <input type="checkbox"
                           onChange={this.handlechange}
                           checked={terminalinformation.showterminallockedoncfd}
                    ...
                    <div className="form-group">
                     ...
                     <div className="">
                        <div className="switch-button switch-button-info">
                           ...
                           disabled
                           onChange={this.handlechange}
                           checked={terminalinformation.isquickservicemode}
                    ...
                    <div className="form-group">
                     ...
                     <div className="">
                        <div className="switch-button switch-button-info">
                           <input type="checkbox"
                           onChange={this.handlechange}
                           checked={terminalinformation.haspaymentgateway}
                    ...
                    <div className="form-group">
                     ...
                     <div className="">
                        <div className="switch-button switch-button-info">
                           ...
                           disabled
                           onChange={this.handlechange}
                           checked={terminalinformation.useorderlabel}
                           name="useorderlabel"
                           id="useorderlabel" />
                    ...
                    <div className="form-group">
                     ...
                     <div className="">
                        <div className="switch-button switch-button-info">
                           <input type="checkbox"
                           onChange={this.handlechange}
                           checked={terminalinformation.rebootonhouseclose}
...
export default EditTerminalForm;