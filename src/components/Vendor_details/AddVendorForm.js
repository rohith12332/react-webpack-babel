...
class AddVendorForm extends React.Component {
  ...
  hasNoHighLimit(event) {
      this.setState({
          hasNoHighLimit: event.target.checked,
  ...
  handleValidation() {
      ...
      if (this.state.vendordetails.emailaddress.trim() === '') {
      }else{
      ...
      if(this.state.vendordetails.lastname.trim() === ''){
      }else{
  ...
  var vendortype = this.state.vendor_type.label;
  ...
  const request = new Request(`${process.env.API_HOST}/ManageVendorAccount.svc/CreateVendorAccount/json`, {
    method: 'POST',
    headers: new Headers({
        ...
        <div className="widget widget-small">
               <div className="row">
                <div className="col-sm-12">
                  <div className="product-widget-head bottom20">Create Vendor</div>
                </div>
              </div>
            ...
            />
             ...
             <div className={classnames('form-group', { error: !!this.state.errors.zipcode})}>
          	 ...
          	 <div className="widget widget-small">
		        ...
		        <Select
		          name="vendortype"
		          value={this.state.vendor_type.value}
		          options={vendorType}
  			...
  			<div className="">
      			<div className="switch-button switch-button-info">
      			   <input type="checkbox" onChange={this.hasNoHighLimit} checked={this.state.hasNoHighLimit} name="s1" id="s1" />
  			...
  			<div className="">
      			<div className="switch-button switch-button-info">
      			   <input type="checkbox" onChange={this.isActive} checked={this.state.isActive} name="s2" id="s2" />
