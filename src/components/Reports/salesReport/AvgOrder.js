...
class AvgOrder extends Component{
	render(ReactElement, DOMElement, callback){
    const AvgOrder = this.props.data;
		return(
    <div className="col-sm-12 col-md-6 col-lg-2">
          <div className="widget widget-pie colorGreen">
             <div className="widget-head-wrap">
                <span className="title orange">Avg Order</span>
                <h2 className="title">
                  <NumberFormat value={AvgOrder} displayType={'text'} thousandSeparator={true} decimalPrecision={3} prefix={Currency()} />
                </h2>
             </div>
