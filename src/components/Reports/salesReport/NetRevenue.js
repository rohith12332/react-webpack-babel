...
class NetRevenue extends Component{
	render(ReactElement, DOMElement, callback){
    const NetRevenue = this.props.data;
		return(
    <div className="col-sm-12 col-md-6 col-lg-2">
          <div className="widget widget-pie colorBlue">
             <div className="widget-head-wrap">
                <span className="title green">Net Revenue</span>
                <h2 className="title">
                  <NumberFormat value={NetRevenue} displayType={'text'} thousandSeparator={true} decimalPrecision={2} prefix={Currency()} />
                </h2>
             </div>
