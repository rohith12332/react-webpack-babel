...
var _ = require('underscore');
  ...
  class EditElectronicPayment extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      errors:{},
      pageHead:{
				pagehead:'Edit ElectronicPayment',
				dashboard: 'Dashboard',
				setup: 'Setup'
			},
	   GatewaysList:[],
  ...
  const request = new Request(`${process.env.API_HOST}/ManageProcessorConfigurations.svc/UpdateProcessorconfiguration/json`, {
    method: 'POST',
    headers: new Headers({
...
onChange(event) {
 ...
 componentDidMount() {
    ...
    this.getSingleElectronicPayment();

  }


getSingleElectronicPayment()
{
    ...
    reqQuery['processorconfigurationid'] = Id;
    const request = new Request(`${process.env.API_HOST}/ManageProcessorConfigurations.svc/GetSingleProcessorConfiguration/json`, {
      method: 'POST',
      headers: new Headers({
        'Content-Type': 'application/json'
      }),
    ...
    fetch(request).then(function(response) {
      ...
      console.log(data);
        that.setState({
          ...
          ElectronicPayment: data.singleprocessorconfiguration,
          SelectedCredit:0,
          SelectedGift  :0
        });
      });
...
export default EditElectronicPayment;
